let eslint = {
    ...
    "array-bracket-newline": {title: "Linebreaks after opening and before closing array brackets", rules_args: `["error","consistent"]`},
    "array-bracket-spacing": {title: "Consistent spacing inside array brackets", rules_args: `["error","never"]`},
    "array-element-newline": {title: "Line breaks after each array element", rules_args: `["error","consistent"]`},
    ...
    "comma-dangle": {title: "require or disallow trailing commas", rules_args: `["error","only-multiline"]`},
    ...
    "no-else-return": {title: "Remove else blocks after return statements in if statements", rules_args: `"error"`},
    "no-extra-bind": {title: "Remove unnecessary calls to .bind()", rules_args: `"error"`},
    "no-extra-boolean-cast": {title: "Remove unnecessary boolean casts", rules_args: `"error"`},
    "no-extra-label": {title: "Remove unnecessary labels", rules_args: `"error"`},
    ...
    "no-implicit-coercion": {title: "Remove shorthand type conversions", rules_args: `[2,{"allow":["!!"]}]`},
    ...
    "no-unused-labels": {title: "Remove unused labels", rules_args: `"error"`},
    ...
    "quote-props": {title: "Quotes around object literal property names should be consistent", rules_args: `["error","consistent"]`},
    ...
    "semi": {title: "Use semicolons instead of ASI", rules_args: `["error","always",{"omitLastInOneLineBlock":true}]`},
